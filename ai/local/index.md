...
* [Debugging](debugging.instructions.md) — SSH to `markr@nanoclaw.lan`, state inventory (locks, fingerprints, sessions, containers, rate-limits, working dirs), and symptom-to-cause lookup table. Load when investigating orchestrator misbehaviour or a stalled/skipped work item.
