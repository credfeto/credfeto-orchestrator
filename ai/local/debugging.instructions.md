...
- `total` — every agent invocation ever spent on the PR. At `MAX_PR_TOTAL_INVOCATIONS` (default 53) the PR is marked Blocked. A PR stuck at a high total that never merges is churning without converging.
