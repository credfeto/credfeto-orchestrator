...
`claude-hooks/{enforce-git-dash-c,enforce-git-identity,reject-obfuscated-commands}` are version-controlled copies of the operator's
...
and `/home/developer/.claude/hooks/enforce-git-identity`).
