...
- Widen claude-settings.json's permissions.allow for gh api (was narrowed to repos/*/releases* only) and add gh project entirely - both were effectively unusable under --permission-mode dontAsk (#1331), including gh api graphql, which the mandated Workflow-board-update sequence depends on. Confirmed via live production denials (#1344)
### Changed
