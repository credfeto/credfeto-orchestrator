...
- Stop invoke_claude from running a single-phase Claude session until it hard-fails on 'Prompt is too long'; proactively track context usage and checkpoint-and-stop before the window is exceeded (#1070)
### Changed
