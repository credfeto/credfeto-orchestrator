...
- Allow 'set -e' as a narrow, argument-scoped carve-out in the reject-obfuscated-commands hook - only the exact, argument-free-except-'-e' invocation is permitted; set +e, set -x, set -o ..., set --, and bare set all remain blocked (#1349)
### Deprecated
### Removed
### Deployment Changes
<!--
