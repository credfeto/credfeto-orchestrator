...
- Discord blocked-item notifications now include the item's actual title and an explicit reason, and the issue agent now recovers cleanly when the working tree has uncommitted changes from an unrelated branch (#1140)
### Changed
